...
=begin
name=Cloudinary::Uploader.upload(params['myfile'][:tempfile],api_key: 211451722866919, api_secret: sgA3L_PJ0UESkI2yEQ3z0IclyrE, cloud_name: arg)

  name=Cloudinary::Uploader.upload(i.name, api_key: 211451722866919, api_secret: 'sgA3L_PJ0UESkI2yEQ3z0IclyrE', cloud_name: 'arg')
...
if params[:uptoggle] == nil
  ...
  i.save
  name=Cloudinary::Uploader.upload('./public/img/' + params['myfile'][:filename], api_key: 211451722866919, api_secret: 'sgA3L_PJ0UESkI2yEQ3z0IclyrE', cloud_name: 'arg')
  def remove_file(file)
    File.delete('./public/img' + params['myfile'][:filename])
  end
